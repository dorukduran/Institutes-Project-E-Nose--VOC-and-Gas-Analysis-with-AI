...
experiment_files = {'Acetone_1-2-5-4 _Open-Closed-Open.mat', 'Acetone_StepMeasurement.mat', 'Acetone+Isopropanol+Ethanol_1-1-5-3_Open-Closed-Open.mat', 'Acetone+Isopropanol+Ethanol_StepMeasurement.mat'};
experiment_descriptions = {...
    '1-2-5-4 Acetone Open-Closed-Open', ...
    'Acetone Step Measurement', ...
    '1-1-5-3 Acetone+Isopropanol+Ethanol Open-Closed-Open', ...
    'Acetone+Isopropanol+Ethanol Step Measurement', ...
};
sensor_names = {'adc_TGS2600', 'adc_TGS2602', 'adc_TGS2610', 'adc_TGS2611', 'adc_TGS2620', 'humidity', 'temperature', 'NOX', 'VOC'};
reaction_time_limits = [11, 16, 9, 16] * 60; % Limits in minutes, converted to seconds
removal_time_limits = [12, 17, 10, 17] * 60; % Limits in minutes, converted to seconds

% Time series parameters
time_start = 1;
time_end = 250;
sampling_interval = 5; % Sampling interval in seconds
threshold = 40; % Threshold value for slope changes
